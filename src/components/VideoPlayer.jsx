    ...
    >
      ...
      <style>{`
        ...
        @media (max-width: 760px) {
          .now-playing p, .time-label { display: none; }
          .side-controls .icon-btn:nth-child(1), .side-controls .icon-btn:nth-child(2), .side-controls .icon-btn:nth-child(3) { display: none; }
          .bottom-bar { padding: 20px 12px 12px; }
        }
      `}</style>
    </motion.div>
  )
