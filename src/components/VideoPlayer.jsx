    ...
    >
      ...
      <style>{`
        ...
        .icon-btn {
          ...
          touch-action: manipulation; outline: none; -webkit-appearance: none; appearance: none;
        }
        ...
        .bottom-row { display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; gap: 16px; }
        ...
        .side-controls { display: flex; align-items: center; gap: 2px; justify-content: flex-end; }
        ...
        @media (max-width: 760px) {
          ...
          .bottom-row { display: flex; flex-direction: column; align-items: stretch; gap: 12px; }
        ...
        @media (max-width: 420px) {
          .transport { gap: 0; }
          .transport .icon-btn { width: 38px; height: 38px; font-size: 14px; }
          .transport .play-btn { width: 46px; height: 46px; font-size: 16px; }
          .skip-icon { font-size: 9px; }
          .skip-icon small { font-size: 11px; }
        }

        @media (orientation: landscape) and (max-height: 500px) {
          .top-bar { padding: 8px 16px; }
          .icon-btn { width: 34px; height: 34px; font-size: 14px; }
          .bottom-bar { padding: 10px 18px calc(8px + env(safe-area-inset-bottom, 0px)); }
          .scrub-track { margin-bottom: 8px; }
          .bottom-row { display: flex; flex-direction: row; align-items: center; gap: 12px; }
          .now-playing { text-align: left; order: 0; }
          .now-playing strong { font-size: 12.5px; }
          .now-playing p { display: none; }
          .time-label { font-size: 10.5px; }
          .transport { order: 1; gap: 0; }
