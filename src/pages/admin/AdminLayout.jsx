      ...
      <motion.div className="status-bar" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="container status-inner">
          <div>
            ...
            <p>
              {folderConnected
                ? <>Conectado a <code>{folderName}</code> — los cambios se guardan directamente en tus archivos.</>
                : fsSupported
                  ? 'No conectado: los archivos se descargarán en lugar de guardarse automáticamente.'
                  : 'Tu navegador no soporta guardado directo. Usa Chrome o Edge de escritorio, o descarga los archivos manualmente.'}
            </p>
          </div>
          {fsSupported && (
            folderConnected
